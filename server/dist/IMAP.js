...
var Worker = (function () {
    ...
    Worker.prototype.Auth = function () {
        return __awaiter(this, void 0, void 0, function () {
            var client;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.connectToServer()];
                    case 1:
                        client = _a.sent();
    ...
    Worker.prototype.getListOfMailboxes = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        return [2, finalMailboxes];
                }
            });
        });
    };
    Worker.prototype.getMailbox = function (callOptions) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, this.connectToServer()];
                    case 1:
                        client = _a.sent();
                        return [4, client.selectMailbox(callOptions.mailbox)];
                    case 2:
                        mailbox = _a.sent();
                        console.log("IMAP.Worker.listMessages(): Message count = " + mailbox.exists);
                        if (!(mailbox.exists === 0)) return [3, 4];
                        return [4, client.close()];
                    case 3:
                        _a.sent();
                        return [2, []];
                    case 4: return [4, client.listMessages(callOptions.mailbox, "1:*", ["uid", "envelope"])];
                    case 5:
                        messages = _a.sent();
                        return [4, client.close()];
                    case 6:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        client = _a.sent();
                        return [4, client.listMessages(callOptions.mailbox, callOptions.id, ["body[]"], { byUid: true })];
                    case 2:
                        messages = _a.sent();
                        return [4, mailparser_1.simpleParser(messages[0]["body[]"])];
                    case 3:
                        parsed = _a.sent();
                        return [4, client.close()];
                    case 4:
                        _a.sent();
                        return [2, parsed.text];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        client = _a.sent();
                        return [4, client.deleteMessages(callOptions.mailbox, callOptions.id, {
                                byUid: true,
                            })];
                    case 2:
                        _a.sent();
